...
tags:
  ...
  - rpc
  - validators
summary: Mainnet is running updated validator and Phantasma RPC builds with reward-calculation fixes, Phoenix genesis token-state repairs, and the April resolution set.
---

- Mainnet is now running updated validator and Phantasma RPC builds.
- The claimable KCAL / staking booster reward calculation fix is active, and Phantasma RPC now mirrors the validator-side calculation for developers reading reward data through the API.
